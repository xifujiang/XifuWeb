...
<frameset rows="70,*" frameborder=0 border="0" framespacing="0">
    ...
    <frameset cols="400,*" frameborder="0" border="20"  framespacing="10">
        <frame src="${pageContext.request.contextPath}/author-left.jsp" name="leftFrame"  scrolling="NO">
        <frame src="${pageContext.request.contextPath}/author-index.jsp" name="author-mainFrame" >
    </frameset>
</frameset>
</html>
